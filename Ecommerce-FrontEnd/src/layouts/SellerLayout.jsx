    ...
    <div className="dashboard-layout">
      ...
      <aside className="dashboard-sidebar">
        ...
        <nav className="dashboard-nav">
          <PermissionGate permission="store.dashboard">
          ...
          <PermissionGate permission="store.shipments">
          ...
          <PermissionGate permission="store.reviews">
          ...
          <PermissionGate permission="store.edit">
