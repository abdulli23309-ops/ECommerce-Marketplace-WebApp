...
const AdminCategoriesPage = () => {
  ...
  const [editingCategory, setEditingCategory] = useState(null);   // used for editing a category or as parent for sub
  ...
  const handleSubCategorySave = async () => {
    ...
    try {
      if (editingSubCategory) {
        await axiosInstance.put(`/categories/${catId}/subcategories/${editingSubCategory.id}`, form);
      } else {
        await axiosInstance.post(`/categories/${catId}/subcategories`, form);
      }
      setModalOpen(false);
  ...
  const handleDeleteSubCategory = async (catId, subId) => {
    ...
    try {
      await axiosInstance.delete(`/categories/${catId}/subcategories/${subId}`);
      refreshSubCategories(catId);
    } catch (err) {
